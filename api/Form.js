...
export default function Form({ onSubmit, onReset, initialData }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch('https://devn.dfos.co/Dcode/server.php/api/save-form', {
        method: 'POST',
        headers: {
  ...
  const tableOptions = [
    ...
    { value: 'departments', label: 'Module Group(Department)' },
  ...
  const columnOptions = [
    ...
    { value: 'company_name', label: 'CompanyName' },
    ...
    { value: 'line_name', label: 'Line Name' },
  ];
  ...
  const filterTypeOptions = [
    ...
    { value: 'assigned_users', label: 'Assigned User' },
    { value: 'is_secondary', label: 'Secondary Form' },
    //Workflow
    { value: 'fvf_main_form_id', label: 'Form ID' },
    ...
    //Users 
    { value: 'user_modules', label: 'Module Id' },
  ...
  const tableColumnMap = {
    ...
    form_via_form_main_forms: ['fvf_main_form_id', 'fvf_main_form_name', 'assigned_users'],
    form_via_form_main_audits: ['fvf_main_audit_id', 'fvf_main_form_id','user_id'],
    form_via_form_main_audit_answers: ['fvf_main_ans_id','fvf_main_audit_id', 'fvf_main_field_option_id', 'answer'],
    departments: ['department_id', 'department_name'],
    plants: ['plant_id', 'plant_name','site_id'],
  ...
  const tableFilterMap = {
    companies: ['company_id','company_status'],
    modules: ['module_id','company_id'],
    users: ['user_id', 'user_modules','company_id','user_role'],
    locations: ['location_id', 'department_id','company_id'],
    form_via_form_main_forms: ['fvf_main_form_name', 'fvf_main_form_id', 'workflow_approve_status', 'fvf_main_form_status', 'module_id','assigned_users','is_secondary'],
    form_via_form_main_audits: ['fvf_main_form_id', 'module_id','user_id'],
    departments: ['department_id', 'plant_id'],
    ...
    sites: ['site_id', 'company_id','user_id'],
    lines: ['line_id', 'department_id','user_id'],
  };
